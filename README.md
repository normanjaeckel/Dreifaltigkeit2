...
* [FullCalendar v3.8.2](https://fullcalendar.io/) by [Adam Shaw](http://arshaw.com/) and others which is licensed under [MIT](https://github.com/fullcalendar/fullcalendar/blob/v3.8.2/LICENSE.txt) including dependencies (see dreifaltigkeit/static/fullcalendar-3.8.2/lib).
